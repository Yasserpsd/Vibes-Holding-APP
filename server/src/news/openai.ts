...
const SYSTEM_PROMPT = [
  ...
  'For each item return: topics (0 to 3 keys that fit), decision (true ONLY for a new official Saudi rule that businesses or investors must follow or can use: a law, regulation, royal decree or order, cabinet decision, ministry or authority ruling, licence or registration rule, fee, tax, incentive, deadline or enforcement date. NOT decision: statements, condemnations, condolences, appointments, promotions, visits, event announcements, sports, awards, foreign or non-Saudi decisions, market or company news), business_angle (sports: true only when the story is about money such as acquisitions, sponsorships, transfer fees, broadcast rights or club finances; other items: true when they concern business, economy, markets or investment), relevance (0 to 100: how useful the item is to Saudi investors and entrepreneurs; 0 unrelated, 100 essential).',
